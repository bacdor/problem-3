...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    VALUES (
      ...
      NULL,
      NULL,
      'Referral sent electronically. Patient records transferred successfully.',
      1,
      NOW() - INTERVAL '7 days',
      NOW() - INTERVAL '7 days'
    );
  ...
  IF NOT EXISTS (
    ...
    VALUES (
      ...
      '555-0102',
      'Laboratory Services',
      'LabCorp Diagnostic Center',
      '456 Health Avenue, City, ST 12345',
      '555-0102',
      true,
      true,
      'LAB-2024-001234',
      30,
      'Results available within 24-48 hours. Check patient portal for updates.',
      2,
      NOW() - INTERVAL '6 days',
      NOW() - INTERVAL '5 days'
    );
  ...
  IF NOT EXISTS (
    ...
    VALUES (
      ...
      '789 Medical Boulevard, Suite 500, City, ST 12345',
      '555-0103',
      true,
      true,
      'CARD-2024-005678',
      60,
      'All lab results have been received and reviewed. Patient records from primary care physician are on file.',
      3,
      NOW() - INTERVAL '4 days',
      NOW() - INTERVAL '1 day'
    );
  ...
  IF NOT EXISTS (
    ...
    VALUES (
      ...
      'Heart & Vascular Institute - Diagnostic Center',
      '789 Medical Boulevard, Suite 300, City, ST 12345',
      '555-0104',
      true,
      true,
      'EKG-2024-009876',
      30,
      'Scheduled after cardiologist consultation. Previous consultation notes available.',
      4,
      NOW() - INTERVAL '3 days',
      NOW() - INTERVAL '3 days'
    );
  ...
  IF NOT EXISTS (
    ...
    VALUES (
      ...
      NULL,
      30,
      'Waiting for cardiology consultation and EKG results before scheduling follow-up.',
      5,
      NOW() - INTERVAL '2 days',
      NOW() - INTERVAL '2 days'
    );
  ...
  IF NOT EXISTS (
    ...
    VALUES (
      ...
      NULL,
      NULL,
      'Referral sent for urgent evaluation due to persistent knee pain.',
      1,
      NOW() - INTERVAL '3 days',
      NOW() - INTERVAL '3 days'
    );
  ...
  IF NOT EXISTS (
    ...
    VALUES (
      ...
      '555-0105',
      'Radiology',
      'City Medical Center - Radiology',
      '123 Main Street, Ground Floor, City, ST 12345',
      '555-0105',
      true,
      true,
      'XR-2024-003456',
      20,
      'X-ray images available for review. No fractures detected.',
      2,
      NOW() - INTERVAL '2 days',
      NOW() - INTERVAL '2 days'
    );
  ...
  IF NOT EXISTS (
    ...
    VALUES (
      ...
      '321 Sports Medicine Drive, Suite 100, City, ST 12345',
      '555-0106',
      true,
      true,
      'ORTH-2024-007890',
      45,
      'X-ray results received. Patient needs to reschedule missed appointment.',
      3,
      NOW() - INTERVAL '1 day',
      NOW() - INTERVAL '1 day'
    );
